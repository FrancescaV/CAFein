...
#################################
constants = "/Users/francesca/Northwestern/Research/constants.dat"
...
basicAddress1 = "/Users/francesca/Northwestern/Research/realModels_eigenvalues_Eigenfunc_gsl_v23_zioGio_readingAllRij_remove_1_over_r/output/"
addressFiles1 = basicAddress1+"/eigenfunctions_y81atSurf_lite.dat"
plotsAddress = basicAddress1+"plots/"

basicAddress2 = "/Users/francesca/Northwestern/Research/realModels_eigenvalues_Eigenfunc_gsl_v23_zioGio_readingAllRij/input/test_suite/non_adiabatic_tidal_eigenfunctions/Output/"
addressFiles2 = basicAddress2+"/eigenfunctions_y81atSurf_lite.dat"
#################################
# plot properties
#################################
#################################
...
##################################
##################################
PSfile = plotsAddress+"eigenfunctions_"+str(xmin)+"_to_"+str(xmax)+".ps"
plt.close('all')
...
y1i  = np.loadtxt(addressFiles, skiprows=2, usecols=(10,))
y2i  = np.loadtxt(addressFiles, skiprows=2, usecols=(11,))
y3i  = np.loadtxt(addressFiles, skiprows=2, usecols=(12,))
y4i  = np.loadtxt(addressFiles, skiprows=2, usecols=(13,))
y5i  = np.loadtxt(addressFiles, skiprows=2, usecols=(14,))
y6i  = np.loadtxt(addressFiles, skiprows=2, usecols=(15,))
