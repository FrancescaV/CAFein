...
addressFiles1 = basicAddress1+"/eigenfunctions_lite.dat"
plotsAddress = basicAddress1+"plots/"

basicAddress2 = "/Users/francesca/Northwestern/Research/realModels_eigenvalues_Eigenfunc_gsl_v23_zioGio_readingAllRij_remove_1_over_r/input/test_suite/non_adiabatic_eigenfunctions/Output/"
...
##################################
##################################
PSfile = plotsAddress+"PureEigenfunctions_"+str(xmin)+"_to_"+str(xmax)+".ps"
plt.close('all')
